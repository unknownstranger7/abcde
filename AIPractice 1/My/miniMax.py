...
def minimax(curr_state,curr_mark):
    ...
    for i in range(0,len(available_cell_index)):
      curr_test_info = {}
        ...
        # intermediate_dict["index"] = curr_state[available_cell_index[i]]
      ...
      if ( curr_mark == aiMark):
          result = minimax(curr_state,humanMark)
            # intermediate_dict["score"] = result[key]["score"]
          if result["score"] == -1:
